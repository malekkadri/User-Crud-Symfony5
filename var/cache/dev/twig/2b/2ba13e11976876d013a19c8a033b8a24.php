...
class __TwigTemplate_5b51157161a231ff36f2bdddb9342e79 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 16
        echo twig_escape_filter($this->env, (isset($context["users"]) || array_key_exists("users", $context) ? $context["users"] : (function () { throw new RuntimeError('Variable "users" does not exist.', 16, $this->source); })()), "html", null, true);
        echo "</div>
                    </div>
                    <div class=\"col-auto\">
...
";
    ...
    {
        return array (  119 => 16,  111 => 10,  108 => 8,  98 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title_h1 \"Tableau de bord\" %}

{% block body %}

    {# First card for number of userss #}
...
{% endblock %}
", "admin/dashboard/index.html.twig", "C:\\Users\\Malik\\Desktop\\Nour3\\Animaland (2) (1)\\Animaland\\templates\\admin\\dashboard\\index.html.twig");
    }
}
